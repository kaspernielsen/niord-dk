...
<#function formatTelephonyCharacter code>
    ...
    <#switch code>
        ...
        <#case "1"><#assign result="Et"/><#break>
        <#case "2"><#assign result="To"/><#break>
        <#case "3"><#assign result="Tre"/><#break>
        <#case "4"><#assign result="Fire"/><#break>
        <#case "5"><#assign result="Fem"/><#break>
        <#case "6"><#assign result="Seks"/><#break>
        <#case "7"><#assign result="Syv"/><#break>
        <#case "8"><#assign result="Otte"/><#break>
        <#case "9"><#assign result="Ni"/><#break>
        <#case "0"><#assign result="Nul"/><#break>
    </#switch>
    <#return result />
</#function>
