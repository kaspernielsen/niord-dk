        ...
        <#else>
            ...
            <#if vessel.contact!false>
                <#if format == 'navtex'>
                    ...
                    listening VHF CH 16<#if vessel.channel?has_content> and ${vessel.channel}</#if>.
                <#else>
                    The <#if vessel.guardVessels!false>vessels are<#else>vessel is</#if>
                    listening on VHF channel 16<#if vessel.channel?has_content> and ${vessel.channel}</#if>.
                </#if>
            </#if>
        </#if>
    </#if>
